...
## [Unreleased](https://github.com/hynek/build-and-inspect-python-package/compare/v3.0.1...HEAD)


## [3.0.1](https://github.com/hynek/build-and-inspect-python-package/compare/v3.0.0...v3.0.1) - 2026-07-30
...
- New input: `skip-sdist` to skip building the source distribution.
  [#228](https://github.com/hynek/build-and-inspect-python-package/issues/228)
...
- The action now passes Zizmor in pedantic mode.
  [#212](https://github.com/hynek/build-and-inspect-python-package/issues/212)


## [2.16.0](https://github.com/hynek/build-and-inspect-python-package/compare/v2.15.0...v2.16.0) - 2026-03-26
