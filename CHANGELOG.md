...
- New outputs: `steps.supported-pythons-setter.outputs.supported_pythons_json_array` and `steps.supported-pythons-setter.outputs.supported_pythons_json_job_matrix_value`.
